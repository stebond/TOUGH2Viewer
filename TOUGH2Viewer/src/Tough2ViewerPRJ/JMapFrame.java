 ...
 *
 * @source $URL:
 * https://svn.osgeo.org/geotools/tags/2.7-M4/modules/unsupported/swing/src/main/java/org/geotools/swing/JMapFrame.java
 * $
 */
public class JMapFrame extends JFrame {
     ...
     * status bar; sets the supplied {@code MapContext}; and displays the frame
     ...
     * {@linkplain JMapFrame.Tool} constants.      <code><pre>
     ...
     * layers in the map context and set their order, visibility and selected
     * status.
     *
    ...
    /**
     * Calls {@linkplain #initComponents()} if it has not already been called
     ...
     * the enable methods (e.g. {@linkplain #enableToolBar(boolean)} ). If not
     * called explicitly by the client this method will be invoked by
     ...
     * {@linkplain #initComponents} has not been called yet this method will
     * invoke it.
     *
