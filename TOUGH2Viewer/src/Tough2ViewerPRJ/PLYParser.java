 ...
 * <p>
 * This parser is only intended for test purposes, it does not parse the full
 * header, it does not handle all properties, it has rudimentary error handling.
 * </p>
 *
 * @since 3.5
 */
...
public class PLYParser {
                    ...
                    case PROPERTY:
                        if (inVertexElt) {
                            ...
                            if (fields.size() != 5
                                    ...
                                    || fields.get(4).getToken() != Token.VERTEX_INDEX) {
                                complain();
                            }
                        } else {
                            complain();
     ...
     * @exception IOException if stream cannot be read
     * @exception ParseException if the line does not contain the expected
     * number of fields
     */
    ...
    private static enum Token {
        ...
        X, Y, Z, VERTEX_INDEX, END_HEADER, UNKNOWN;
    }
