 ...
 * @author stebond
 */
class ReadDataFileActivity extends SwingWorker<Void, Integer> {
     ...
     */
    public ReadDataFileActivity(int t, String filename, JProgressBar progressBar) {
...
//               File mydata2=new File(filename);
            Tough2Viewer.dataobj.readDataFile3(mydata, true, myprogressBar);
